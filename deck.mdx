...
- <Dot /> Has traditional work been <Underline>fighting</Underline> against the
  tide?
...
- <Dot />
  We use Santander <Underline>Digital Trust</Underline> for identity verification.
...
- <Dot /> Recommendations <Underline>AI engine</Underline>
...
- <Dot />
  <Underline>MVP</Underline>, API, Npm published Design System
- <Dot /> 5 Git <Underline>repos</Underline>, Figma-created Designs, Video
- <Dot />
  See more details <a
...
- <Dot />
  <a href="https://www.nomadsprint.com" target="_blank">
    Demo of MVP
  </a>
